...
def saveLoadHelp():
    ...
    print()
    type_effect('if you wish to create a new file, you will be promted for a name and password(password not required, only needed for protecting save file)')
    print()
    type_effect('if you wish to save to an existing file, you will be asked for the save code and password)if needed) and the new save file will overwrite an existing one')
    print()
    print('--------------------------------------')
